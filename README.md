...
Snippets:
- [Sync and Async file upload](snippets/sync-and-async-file-upload/)
- [Running blocking functions in async endpoints](snippets/threadpool-executor/)
- [Protect API endpoint](snippets/protected-routes/)
- [Monitor active threads when using sync dependencies](snippets/monitor-active-threads/)

APIs:
- [FastCRUD + SQLAlchemy](apis/fastcrud-sqlalchemy-api/)
- [FastCRUD + SQLModel (autogenerated routes)](apis/fastcrud-api-with-autogenerated-routes/)
- [FastCRUD + SQLModel (custom routes)](apis/fastcrud-api-with-custom-routes/)
- [FastCRUD + SQLModel + FastAPI Cache(Redis)](apis/crud-api-with-redis-cache/)
- [FastCRUD + SQLModel + SQLAdmin](apis/fastcrud-sqlalchemy-api/)
- [FastAPI + Tortoise ORM](apis/tortoise-orm-crud-api/)
- [FastAPI + Redis OM CRUD API](apis/redis-om-crud-api)
- [Dockerized FastAPI + Beanie(MongoDB)](apis/mongodb-crud-api-1/)
- [FastAPI + Motor(MongoDB)](apis/mongodb-crud-api-2/)
- [FastAPI + Httpx (integration with 3rd-party API)](apis/httpx-api/)
- [FastAPI + AWS S3 (aiobotocore)](apis/aws-s3-management-api/)
- [FastAPI + GraphQL(Graphene) CRUD API](apis/graphql-graphene-crud-api/)
- [FastAPI + Websockets + Redis Streams](apis/websockets-with-redis-streams/)
- [FastAPI + SQLAlchemy + FastAPI Users](apis/fastapi-users-auth-api/)
